...
const BUILTIN_TEMPLATES = {
    conservative: {
        ...
        rehabCostsPct:      5,      // % of purchase price
        occupancyRate:      92,
        vacancyPct:         8,
        propMgmtMode:      'pct',
        propMgmtPct:        10,
    ...
    standard: {
        ...
        loanTermYears:      30,
        originationFee:     1,
        closingCostsPct:    2.5,    // % of purchase price
        rehabCostsPct:      1,      // % of purchase price
        occupancyRate:      95,
        vacancyPct:         5,
        propMgmtMode:      'pct',
        propMgmtPct:        8,
    ...
    aggressive: {
        ...
        loanTermYears:      30,
        originationFee:     0.5,
        closingCostsPct:    1.5,    // % of purchase price
        rehabCostsPct:      0,      // turnkey assumption
        occupancyRate:      97,
        vacancyPct:         3,
        propMgmtMode:      'pct',
        propMgmtPct:        6,
